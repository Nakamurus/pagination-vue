...
// @mixin allows to use arguments => css function
// must call it using @include
@mixin sizing($args, $prefix: "") {
    // if(condition, returns if true, if false)
    // nth($args, 1) returns the element of $args at index 1
    // length($args) returns number of elements of the list
